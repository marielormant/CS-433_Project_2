"""
Random Forest Final Model (best hyperparameters from Optuna)
...
# 3) Train final Random Forest (Optuna best hyperparameters)
safe_weight = 0.9732238881205381
unsafe_mult = 2.6532678113666086
classes = np.unique(y_train)
class_weights = {"safe": safe_weight, **{cls: unsafe_mult for cls in classes if cls != "safe"}}
