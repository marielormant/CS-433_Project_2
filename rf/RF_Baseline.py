"""
Random Forest Baseline Model (no class weighting, no hyperparameter optimization)
...
- Saves: random_forest_baseline.pkl
"""
...
print(f"Safety FN (unsafe predicted safe): {false_negatives}")

# 5) Save model
joblib.dump(model, "random_forest_baseline.pkl")
